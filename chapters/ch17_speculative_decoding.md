...
short_title: "ch17 Speculative Decoding"
---
...
```{include} _generated/ch17-acceptance.md
```
...
```{include} _generated/ch17-distribution.md
```
...
Speculation constrains *which* tokens appear by proposing them. {ref}`ch18` constrains which tokens
